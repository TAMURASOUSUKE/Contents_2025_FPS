...
public class ColorManager : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetKeyDown(KeyCode.Alpha1))
        {
            ...
            {
                // 例：赤い色フィルターを設定
                colorAdjustments.colorFilter.value = new Color(1f, 0f, 0f, 0.4f);
            }
        }
        if (Input.GetKeyDown(KeyCode.Alpha2))
        {
            ...
            {
                // 例：緑色フィルターを設定
                colorAdjustments.colorFilter.value = new Color(0f, 1f, 0f, 0.4f);
            }
        }
        if (Input.GetKeyDown(KeyCode.Alpha3))
        {
            ...
            {
                // 例：青色フィルターを設定
                colorAdjustments.colorFilter.value = new Color(0f, 0f, 1f, 0.4f);
            }
        }
